...
| 15:30 - 16:30 | Theming & Publishing  |
...
::: aside
See [here](https://posit-conf-2024.github.io/shiny-r-intro/data/) for a full data dictionary
:::
...
Open `exercises/ex01.R`, or Copy the code from the previous slide, and run it via the Run App button in RStudio.
