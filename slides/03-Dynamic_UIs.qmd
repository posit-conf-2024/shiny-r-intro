---
title: "Getting Started with Shiny<br/>Dynamic UIs"
author: "Colin Rundel"
format: 
  revealjs:
...
They differ from other UI elements we've seen so far as they are usually defined within an app's server function and not the ui.
...
```{r}
#| eval: false
#| code-line-numbers: "|33|42-59|61-78"
#| file: ../demos/demo07.R
```
...
::: aside
See Bootstrap's [background](https://getbootstrap.com/docs/5.3/utilities/background/) and [color](https://getbootstrap.com/docs/5.3/utilities/colors/) documentation for class options.
:::
